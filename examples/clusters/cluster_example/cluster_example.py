...
def getCluster():
    ...
    # Host definitions
    #---------------------------------------------------------------------------
    metamanager1 = Host('metamanager1.xrd.test', '192.168.127.3')
    manager1 = Host('manager1.xrd.test', '192.168.127.4')
    manager2 = Host('manager2.xrd.test', '192.168.127.5')
    ds1 = Host('ds1.xrd.test', '192.168.127.6')
    ds2 = Host('ds2.xrd.test', '192.168.127.7')
    ds3 = Host('ds3.xrd.test', '192.168.127.8')
    ds4 = Host('ds4.xrd.test', '192.168.127.9')
    client1 = Host('client1.xrd.test', '192.168.127.10')
