...
def getTestSuite():
    ...
    ts.schedule = dict(second='47', minute='52', hour='*', day='*', month='*')
...
def getTestCases():
    ...
    tc1.initialize = "file://" + tc1.name + "/init.sh"
    tc1.run = "file://" + tc1.name + "/run.sh"
    tc1.finalize = "file://" + tc1.name + "/finalize.sh"
    tcs.append(tc1)
